...
const contentData = [
  ...
  href:'https://arbitrum.io/',
    ...
    { id:2,
      src: '/lisk2.png',
    title: 'Lisk',
    description: 'Lisks sidechains ensure scalability, support development, fostering innovation and cross-chain compatibility',
    href:'https://lisk.com/',
  },
  { id:3,
    src: '/avax.png',
...
<div className="md:w-2/5">
          <h3 className="text-gray-300 font-semibold text-2xl">Security Contributors</h3>
          <p className="text-gray-500 pt-1">Audited by the worlds leading security firms, security of the Aave Protocol is the highest priority.</p>
...
<h3 className="font-bold text-center text-2xl ">Aave Community Treasury</h3>
<h1 className="font-bold text-center text-2xl  lg:text-3xl pb-4">$ 104,748,502</h1>
...
<div>
<h3> The Aave treasury is composed of the ecosystem reserve (AAVE tokens) and treasury collectors which earn fees from :</h3>
<ul className="list-disc pl-6 text-sm py-3">
<li> Reserve factor: percentage of protocol interest paid by borrowers.</li>
<li>Instant Liquidity: percentage of fees from instant liquidity transactions (V3 only)</li>
<li>Liquidation fees: percentage of collateral liquidation bonus (V3 only, not yet active)</li>
<li>Portal fees: paid by bridging protocols to re-back assets (V3 only, not yet active)</li>
</ul>
</div>
...
<div className="flex items-center gap-2"><span className="bg-yellow-400 rounded-full  h-3 w-3"></span> Lisk</div>
</div>
<div className="flex flex-col gap-2">
<h4>45.0%</h4>
<span className="bg-purple-600 w-48 h-1 lg:w-24"></span>
<div className="flex items-center gap-2"><span className="bg-purple-600 rounded-full  h-3 w-3"></span> Polygon</div>
</div>

<div className="flex flex-col gap-2 ">
<h4>20.0%</h4>
<span className="bg-red-400 w-32 h-1 lg:w-24"></span>
<div className="flex items-center gap-2"><span className="bg-red-400 rounded-full  h-3 w-3"></span> Arbitruim</div>
</div>

<div className="flex flex-col gap-2">
<h4>12.0%</h4>
<span className="bg-red-700 w-24 h-1 lg:w-16"></span>
<div className="flex items-center gap-2"><span className="bg-red-700 rounded-full  h-3 w-3"></span> Avax</div>
</div>

<div className="flex flex-col gap-2">
<h4>18.0%</h4>
<span className="bg-blue-400 w-16  h-1 lg:w-16"></span>
<div className="flex items-center gap-2"><span className="bg-blue-400 rounded-full  h-3 w-3"></span> Optimsim</div>
</div>
